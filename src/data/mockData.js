...
export const INITIAL_LAYOUTS = [
  {
    ...
    status: 'Verified', // 'Uploaded', 'Processing', 'Needs Verification', 'Verified', 'Published'
    originalPdfUrl: '/docs/Sky_Cadastral_Master_Layout_Phase1.pdf',
    originalPdfName: 'Sky_Cadastral_Master_Layout_Phase1.pdf',
    fileSize: '4.8 MB',
    uploadedAt: '2026-08-01',
    scaleFactor: 1.0, // 1 unit = 1 ft
    boundingWidth: 800,
    boundingHeight: 600,
    extractedPlotsCount: 16
  },
  {
    id: 'LAYOUT-002',
    projectId: 'AREA-002',
    projectName: 'Sky Cadastral Phase 2',
    name: 'Commercial Hub Layout',
    status: 'Published',
    originalPdfUrl: '/docs/Sky_Cadastral_Phase2_Commercial.pdf',
    originalPdfName: 'Sky_Cadastral_Phase2_Commercial.pdf',
    fileSize: '6.2 MB',
    uploadedAt: '2026-08-05',
    scaleFactor: 1.0,
    boundingWidth: 800,
    boundingHeight: 600,
    extractedPlotsCount: 8
  }
];
...
export const INITIAL_PLOTS = [
  ...
  },
  {
    ...
    length: 48,
    width: 30,
    documentArea: 1500, // Intentional Mismatch
    facing: 'North-West',
    facingRoadWidth: 30,
    // Irregular Polygon geometry to showcase non-rectangular cadastral extraction!
    polygonGeometry: [
      [520, 175],
      [710, 175],
      [740, 250],
